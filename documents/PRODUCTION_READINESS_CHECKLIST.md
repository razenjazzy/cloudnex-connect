...
v10.0.4 is Odoo LINE OA v7: production process on `/opt/cloudnex-connect`, staging Admin on `/opt/cns-line-oa`. Cloud Run `deploy:prod` boxes below stay unchecked.
