...
**Release:** v9.0.6 — Odoo LINE OA v6 staging. Production deploy is not this cut.  
...
| Admin | Path |
|---|---|
| Console | `https://amardhaka.io/cloudnex-connect/admin` |
| Campaigns | `/cloudnex-connect/admin/campaigns` |
| Advanced (disabled) | `/cloudnex-connect/admin/advanced` |
